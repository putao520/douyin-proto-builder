...
/**
 * @generated from protobuf message live.ListRoomStatsData
 */
export interface ListRoomStatsData {
}
/**
...
class InteractionContent$Type extends MessageType<InteractionContent> {
    ...
    create(value?: PartialMessage<InteractionContent>): InteractionContent {
        const message = { priority: 0, loopCount: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class AuctionInfo$Type extends MessageType<AuctionInfo> {
    ...
    create(value?: PartialMessage<AuctionInfo>): AuctionInfo {
        const message = { price: 0n, priceLabel: "", status: 0, jumpUrl: "", buttonLabel: "", productId: 0n, endTime: 0n, bizId: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class ProductListUpdateMessage$Type extends MessageType<ProductListUpdateMessage> {
    ...
    create(value?: PartialMessage<ProductListUpdateMessage>): ProductListUpdateMessage {
        const message = { updateTimestamp: 0n, updateToast: "", total: 0n, msgType: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
// @generated message type with reflection information, may provide speed optimized methods
class ListRoomStatsData$Type extends MessageType<ListRoomStatsData> {
    constructor() {
        super("live.ListRoomStatsData", []);
    }
    create(value?: PartialMessage<ListRoomStatsData>): ListRoomStatsData {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<ListRoomStatsData>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListRoomStatsData): ListRoomStatsData {
        return target ?? this.create();
    }
    internalBinaryWrite(message: ListRoomStatsData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message live.ListRoomStatsData
 */
export const ListRoomStatsData = new ListRoomStatsData$Type();
// @generated message type with reflection information, may provide speed optimized methods
